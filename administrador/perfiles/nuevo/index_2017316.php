					...
					if($id_perfil>0):
						...
						if(($p_perfil=="Perfil 2" or $p_perfil=="Perfil 3") and !empty($p_numero_productos)):
							for($con_pro=1;$con_pro<=$p_numero_productos;$con_pro++):
								...
								if(!empty($p_titulo_producto)):
									//Registrar
									$c_pro=insertar("id_perfil,tipo,producto","productos_perfiles","'".$id_perfil."','".$p_tipo_producto."','".$p_titulo_producto."'");
								endif;	
						...
						if(count($p_servicios)):
							foreach($p_servicios as $servicio):
								//Registrarlo
								$c_serv=insertar("tipo, producto ,id_perfil","productos_perfiles","'Servicio','".$servicio."','".$id_perfil."'");
							endforeach;
						endif;
						//CATEGORIAS
						//Borrar si es que existe alguno
               ...
               <td colspan="2">
                  ...
                  <div id="div_regalos">
                     <table border="0" cellpadding="3" cellspacing="1" width="100%" align="left" class="text_gral">
                        <tr>
                           <td>Regalo</td>
                           <td><input type="text" name="regalo1" style="width:90%;" maxlength="255" required>*</td>
                        </tr>
                     </table>   
                  </div>
               </td>
               ...
               <td colspan="2">
                  ...
                  <div id="div_recompensas">
                     ...
                     <table border="0" cellpadding="3" cellspacing="1" width="100%" align="left" class="text_gral">
                        <tr>
                           <td>Recompensa</td>
                           <td><input type="text" name="recompensa1" style="width:90%;" maxlength="255" required>*</td>
                        </tr>
                        <tr>
                           <td>Estatus</td>
					...
					<tr>
						<td>
                        	...
                        	<input type="checkbox" name="servicios[]" value="Wifi"> Wifi
         					...
         					<div style="display:inline-block; margin-right:15px; margin-bottom:7px;">
                        	<input type="checkbox" name="servicios[]" value="Conexión eléctrica (para cargar aparatos eléctricos)"> Conexión eléctrica (para cargar aparatos eléctricos)
                        	</div> 
                        	<div style="display:inline-block; margin-right:15px; margin-bottom:7px;">
