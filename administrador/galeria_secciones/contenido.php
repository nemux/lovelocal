...
$campos="ban.id_foto,sec.seccion,ban.titulo,ban.imagen,ban.orden,ban.estatus";
$tablas="fotos_secciones ban LEFT OUTER JOIN secciones sec ON sec.id_seccion=ban.id_seccion";
...
<table width="100%">
   ...
   <?
	...
	while($f_id=$c_id->fetch_assoc()):
		...
		?>
      <tr class="txt_center">
      	<td style="text-align:center"><input type="checkbox" name="arreglo_registros[]" value="<?=$id_foto?>"/></td>
         <td><?=$titulo?></td>
         <td>
				<?
