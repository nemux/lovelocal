...
//echo $campos." from clientes ".$condicion2."<br>";
?>
...
<form id="form_contenido" name="form_contenido" method="post" action="./">
   ...
   <?
	...
	while($f_id=$c_id->fetch_assoc()):
		...
		?>
     <tr class="txt_center">
      	<td><input type="checkbox" name="arreglo_registros[]" value="<?=$id_cliente?>"/></td>
