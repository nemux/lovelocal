...
if(!empty($p_numero)):
	?>
	<fieldset>
	<legend>Promoción <?=$p_numero?></legend>
	<table border="0" cellpadding="3" cellspacing="1" width="80%" align="left" class="text_gral" id="tbl_promocion<?=$p_numero?>">
		<tr>
			<td>Promoción</td>
			<td><input type="text" name="promocion<?=$p_numero?>" style="width:400px;" maxlength="255" required>*</td>
		</tr>
		<tr>
			<td>Imagen</td>
