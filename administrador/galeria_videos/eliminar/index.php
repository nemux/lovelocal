...
if(!empty($p_registros)):
	...
	for($i=$contador; $i< $cuantos; $i++):
		...
		$c_se1=buscar("ban.titulo
							"
							,"videos_secciones ban"
							,"WHERE ban.id_video=".$registro."");
		...
		//Eliminar registros
		$eliminar_registro= eliminar("videos_secciones","WHERE id_video=".$registro."");
	...
	$c_cl2=autonumerico("id_video","videos_secciones");
