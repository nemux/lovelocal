...
if(!empty($p_numero)):
	...
	<table border="0" cellpadding="3" cellspacing="1" width="80%" align="left" class="text_gral" id="tbl_video<?=$p_numero?>">
		<tr>
         <td>Sección</td>
         <td>
            <?
		...
		<tr>
			<td>Enlace</td>
			<td>
				<textarea name="enlace<?=$p_numero?>" id="enlace<?=$p_numero?>" style="width:600px; height:100px;"></textarea> Ej. https://www.youtube.com/watch?v=t8IO9Izi5xo
			</td>
		</tr>
		<tr>
			<td>Orden</td>
