...
if(!empty($p_registros)):
	...
	for($i=$contador; $i< $cuantos; $i++):
		$registro= $arreglo[$i];
		$c_se1=buscar("titulo,imagen","redes_sociales","WHERE id_red=".$registro);
		...
		//Eliminar registros
		$eliminar_registro= eliminar("redes_sociales","WHERE id_red=".$registro);
	...
	$c_cl2=autonumerico("id_red","redes_sociales");
