...
// Translator: Andr&eacute; Liechti, <developer@sysco.ch> (2006-01-04) from scratch for version 1.x
...
"Distribu&eacute; sous licence GNU LGPL.  Voir http://gnu.org/licenses/lgpl.html pour les d&eacute;tails." + "\n(licence traduite en français: http://www.rodage.org/lgpl.fr.html)" +
"\n\n" +
...
Calendar._TT["PREV_YEAR"] = "Ann&eacute;e pr&eacute;c. (maintenir pour afficher menu)";
Calendar._TT["PREV_MONTH"] = "Mois pr&eacute;c. (maintenir pour afficher menu)";
Calendar._TT["GO_TODAY"] = "Atteindre la date du jour";
Calendar._TT["NEXT_MONTH"] = "Mois suiv. (maintenir pour afficher menu)";
Calendar._TT["NEXT_YEAR"] = "Ann&eacute;e suiv. (maintenir pour afficher menu)";
Calendar._TT["SEL_DATE"] = "S&eacute;lectionner une date";
Calendar._TT["DRAG_TO_MOVE"] = "Glisser pour d&eacute;placer";
