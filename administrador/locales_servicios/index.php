...
if(empty($se_id_usuario)):
   ...
   <?
	...
	<title>LOCALES O SERVICIOS</title>
   ...
   <script src="ajax.js"></script>
	...
	<div id="contenedor">
      ...
      <div class="div_separador">&nbsp;</div>
		...
		<div id="contenido">
         <div class="titulo_paginacion">Consulta de LOCALES O SERVICIOS</div>
			<div class="div_separador">&nbsp;</div>	
         ...
         <div id="div_contenido">
				<?// include("contenido.php");?>En Desarrollo
         </div>
		</div>
		<div id="pie">
			<?
