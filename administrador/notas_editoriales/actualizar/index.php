...
<script language="javascript" type="text/javascript">
   ...
   image_advtab: true ,   
   external_filemanager_path:"http://www.lovelocal.mx/administrador/js/filemanager/",
   filemanager_title:"Responsive Filemanager" ,
   external_plugins: { "filemanager" : "http://www.lovelocal.mx/administrador/js/filemanager/plugin.min.js"}
    })
	...
	<div id="contenedor">
		...
		<div id="contenido">
         ...
         #form1 .nicEdit-main{
            ...
            ?>
            <select name="perfil<? echo $registro; ?>">
  ...
  $local=cadena($f_per["local"]);
    ?>
    <option value="<?php echo $id_perfil; ?>" <?php if($perfil==$id_perfil): ?> selected <?php endif;?>><?php echo $local; ?></option>
    <?php
  endwhile;
  ?>
  </select>
