...
<head>
<title>Registro de Clientes - Panel de Administración - ZiiKFOR</title>
<!-- Favicon -->
                 		...
                 		<?
                           ...
                           <?
                              ...
                              location.href="../cliente_datos/";
								...
								$loginUrl = $helper->getLoginUrl('http://ziikfor.com/registro-clientes/index.php', $permissions);
				...
				jQuery.ajax({
					 ...
					 success:function(response){
						...
						if(jQuery('#message_registro div.alert-success').length){
							...
							setTimeout(function(){
								if(id_perfil>0){
									jQuery(location).attr('href','http://www.ziikfor.com/perfil/?per='+id_perfil);
								}
								else{
