   ...
   <section class="ls section_padding_10 topmargin_20">
      ...
      <div class="col-sm-10 homepage">
        ...
        $date = date_format($date,"j M, Y");
            ...
            ?>
            <a  href="../nota_editorial/?not=<?=$id_nota?>&nota=<?=$nota?>">
      ...
      <?php
                ...
                //Buscar promociones
                              $c_pro=buscar("p.local, pro.id_perfil,pro.id_promocion,pro.promocion,pro.imagen,pro.descripcion_corta","promociones_perfiles pro, perfiles p","WHERE pro.estatus='Activo' AND pro.id_perfil=p.id_perfil ORDER BY RAND() limit 7",false);
                              if($c_pro->num_rows>0):
                                 ?>
                          ...
                          <article class="isotope-item col-lg-12 col-md-12 col-sm-12 col-xs-12 post format-standard">
                            ...
                            if(!empty($imagen_promocion) and file_exists("../administrador/promociones/images/".$imagen_promocion)):
                              ?>
                                 ...
                                 <header class="promociontexto entry-header" style=" background:#0b5896; padding:5px">
                  <?
                  if(!empty($promocion)):
                  ?>
