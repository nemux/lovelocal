...
$p_orderby=isset($_GET["orderby"]) ? cadenabd($_GET["orderby"]) : "";
$p_orden=isset($_GET["orden"]) ? cadenabd($_GET["orden"]) : "ASC";
$p_pag=isset($_GET["pag"]) ? $_GET["pag"]*1 : 0;
/*
echo "categorias: ";
print_r($p_categorias);
echo "<br>Ubicaciones: ";
                          	...
                          	$num_total_registros=$c_reg->num_rows;
								  if($num_total_registros>0):
										...
										switch($p_orderby):
											...
											break;
											case "default":
												$ord_per.=" ORDER BY per.id_perfil ".$p_orden;
											break;
										endswitch;
          ...
          <form method="get" action="/" class="form-inline">
              ...
              <div class="form-group">
                  ...
                  <select class="form-control" name="precio" id="precio">
							<option>Todos</option>
                     <option value="0-200" <? if($p_precio=="0-200"): ?> selected <? endif;?>>Hasta $200</option>
                     <option value="200-400" <? if($p_precio=="200-400"): ?> selected <? endif;?>>$200 - $400</option>
                     <option value="400-600" <? if($p_precio=="400-600"): ?> selected <? endif;?>>$400 - $600</option>
                     <option value="600-800" <? if($p_precio=="600-800"): ?> selected <? endif;?>>$600 - $800</option>
                     <option value="800-1000" <? if($p_precio=="800-1000"): ?> selected <? endif;?>>$800 - $1000</option>
                     <option value="1000-1200" <? if($p_precio=="1000-1200"): ?> selected <? endif;?>>$1000 - $1200</option>
                     <option value="1200-adelante" <? if($p_precio=="1200-adelante"): ?> selected <? endif;?>>$1200 - en adelante</option>
                 	</select>
              </div>
            ...
            <ul class="list-unstyled">
            	<?
                  ...
                  <li>
                     <div class="checkbox">
                        <label>
                            <input name="categorias[]" value="<?=$id_categoria?>" type="checkbox" <? if(count($p_categorias)>0 and in_array($id_categoria,$p_categorias)==true): ?> checked <? endif;?>>
                            <?=$categoria?>
                        </label>
                     </div>                  
                  </li>
             ...
             <ul>
             	<?
                  ...
                  <?
                     ...
                     <div class="checkbox">
                        <label>
                            <input name="ubicaciones[]" value="<?=$municipio?>" type="checkbox" <? if(count($p_ubicaciones)>0 and in_array($municipio,$p_ubicaciones)==true): ?> checked <? endif;?>>
                            <?=$municipio?>
                        </label>
                     </div>                  
                  </li>                  
