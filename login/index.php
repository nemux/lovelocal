              ...
              <div class="row">
                 ...
                 <div class="col-sm-6 ls_fondo4">
                  ...
                  <form  class="shop-register" role="form" method="post" action="">
                      ...
                      <div class="col-sm-12 col-md-12 col-lg-12">
                      	<a href="http://www.lovelocal.mx/forgot/">Olvidaste tu contraseña? </a>
                      </div>
                  </form>
                  </div>
                 		...
                 		<?
                           ...
                           <?
                              ...
                              location.href="../cliente_datos/";
								...
								$loginUrl = $helper->getLoginUrl('http://www.lovelocal.mx/login/index.php', $permissions);
					 ...
					 success:function(response){
						if(response=="exito"){
							if(tipo_usuario=="perfil"){
								jQuery(location).attr('href','http://www.lovelocal.mx/perfil_datos/');
							}
