...
if(!empty($p_per)):
	...
	endwhile;
	//$ruta=urlencode("http://www.ziikfor.com/perfil/?per=".$id_perfil."&perfil=".$local);
	$ruta="http://www.ziikfor.com/perfil/?per=".$id_perfil."&perfil=".$local;
	$ruta_imagen="";
	if(!empty($imagen_perfil) and file_exists("../administrador/perfiles/images/".$imagen_articulo)):
		//$ruta_imagen=urlencode("http://www.ziikfor.com/administrador/perfiles/images/".$imagen_perfil);	
		$ruta_imagen="http://www.ziikfor.com/administrador/perfiles/images/".$imagen_perfil;	
	endif;
endif;
?>
<!doctype html>
                      ...
                      <div itemscope="" itemtype="http://schema.org/Product" class="product type-product row">
                          ...
                          <div class="images col-sm-4">
                                 ...
                                 <a href="../administrador/perfiles/images/<?=$imagen_perfil?>" itemprop="image" class="main-image zoom" title="" data-gal="prettyPhoto[product-gallery]">
                                     ...
                                     <span class="newproduct">New</span>
                                   	*/ ?>
                                     <img src="http://www.ziikfor.com/administrador/perfiles/images/<?=$imagen_perfil?>" class="attachment-shop_single wp-post-image" alt="<?=$local?>" title="<?=$local?>" rel="image_src">
                                 </a>
                                 <?
										endif;
                              ...
                              <div class="product-rating" itemprop="aggregateRating" itemscope="" itemtype="http://schema.org/AggregateRating">
                                  ...
                                  <span class="review-links pull-right">
                                      <a href="#comments" class="review-link" rel="nofollow">
                                          <span itemprop="reviewCount" class="count"><?=$numero_evaluacion?></span> evaluacion(es)
                                      </a> 
                                ...
                                <div class="col-sm-4">
                                 <?
                                          ...
                                          <div class="cs shop-teaser">
                                            ...
                                            <p><a href="../registro-clientes/?per=<?=$id_perfil?>">Regístrate en Ziikfor y descarga tu Cupón.</a></p>
                                          </div>
                                          <?
													else:
                      	...
                      	<?
								if(!empty($se_id_cliente) and !empty($se_usuario_cliente) and !empty($se_password_cliente)):
									...
									$c_cli=buscar("usuario,email","clientes","WHERE id_cliente='".$se_id_cliente."' AND usuario='".$se_usuario_cliente."' AND password='".$se_password_cliente."'");
                           ...
                           <div class="table-responsive">
                             ...
                             <form class="comment-form" id="commentform">
                                 <p class="comment-form-author">
                                     ...
                                     <input type="text" aria-required="true" size="30" name="usuario" id="usuario" class="form-control" placeholder="Usuario">
                                 </p>
                                 <p class="comment-form-email">
                                     <label for="email">Email <span class="required">*</span></label>
                                     <input type="email" aria-required="true" size="30" name="email" id="email" class="form-control" placeholder="Email">
                                 </p>
                                 <p class="comment-form-chat">
                                     <label for="comentario">Comentario</label>
                                     <textarea aria-required="true" rows="4" cols="45" name="comentario" id="comentario" class="form-control" placeholder="Comentario"></textarea>
...
if(!empty($direccion)):
   ...
   <script type="text/javascript">
      ...
      window.dxmapLoadMap = function()
      {
         ...
         var image = {
             url: 'http://www.ziikfor.com/images/icon_ziikfor.png',
