...
if(!empty($se_id_perfil) and empty($errors)):
   ...
   #form_recompensas{display: block; margin:10px auto; /*background:rgba(0, 0, 0, 0.1); */border-radius: 10px; padding: 15px }
	#form_recompensas .nicEdit-main{
		background-color:#FFFFFF;
	}
   .progress_recompensas{position:relative; width:100%; border: 1px solid #ddd; padding: 1px; border-radius: 3px; }
   .bar_recompensas{background-color:#0087a4;width:0%; height:33px; border-radius: 3px; margin:0 !important;}
   .percent_recompensas{position:absolute;color:#FFFFFF !important;display:inline-block; top:3px; left:48%; }
   </style>   
   <form id="form_recompensas" action="../inc/ajax_recompensas.php" method="post" enctype="multipart/form-data">
	...
	<div class="row">
		...
		<div class="col-sm-10 col-md-10 col-lg-10">
			<input type="text" name="recompensa" maxlength="255" required="required"> *
		</div>
	</div>                       		
	<div class="row">
		<div class="col-sm-2 col-md-2 col-lg-2">
	...
	<div class="row">
		...
		<div class="col-sm-10 col-md-10 col-lg-10">
			<button type="submit" id="form_recompensas_submit" name="form_recompensas_submit" class="theme_button">Registrar recompensa</button>
		</div>
	</div>
	<div class="row">
      <div class="col-sm-2 col-md-2 col-lg-2">
