...
$p_action=$_POST['action_cupones_promocion'];
...
if(!empty($se_id_perfil) and  !empty($p_id_cupon) and $p_action=="send" and empty($errors)):
	...
	$c_id=actualizar($actualizar,"promociones_clientes","WHERE id_registro='".$p_id_cupon."'");
	if(!$c_id):
		$arreglo_respuestas[]='<div class="error">No fue posible actualizar el cupón de promoción.</span>';
	else:
		$arreglo_respuestas[]='<div class="exito">El cupón de promoción ha sido actualizado exitosamente.</span>';
	endif;
