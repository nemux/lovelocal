   ...
   <div class="container">
      <div class="row">
         <div class="col-lg-3 col-md-4 col-xs-12">
            <a href="http://www.ziikfor.com/" class="logo top_logo"><img src="../images/logo.png" alt=""></a>
            ...
            <div class="page_social_icons">
               ...
               <a class="enlace">Regístrate</a>
                | */
                  ...
                  <a href="http://www.ziikfor.com/cliente_datos/" style="color:#03538E;font-size:16px;font-weight:bold;">Mis datos</a> |
               	<a class="enlace" href="http://www.ziikfor.com/logout/" style="color:#03538E;">Salir</a>   
                  <?
                  ...
                  <a href="http://www.ziikfor.com/perfil_datos/" style="color:#03538E;font-size:16px; font-weight:bold;">Mis datos</a> |
               	<a class="enlace" href="http://www.ziikfor.com/logout/" style="color:#03538E;">Salir</a>   
                  <?
					else:
						?>
                  <a class="enlace" href="http://www.ziikfor.com/login/">Ingresa</a> / <a class="enlace" href="http://www.ziikfor.com/registro-clientes/">Registro</a>
                  <?
					 endif;
					 ?>
               <!--
