...
if(!empty($se_id_perfil) and empty($errors)):
   ...
   <form id="form_articulos" action="../inc/ajax_articulos.php" method="post" enctype="multipart/form-data">
	...
	<div class="row">
		...
		<div class="col-sm-10 col-md-10 col-lg-10">
			<input type="text" name="articulo" maxlength="255" required="required"> *
		</div>
	</div>                       		
	<div class="row">
	...
	<div class="row">
		...
		<div class="col-sm-10 col-md-10 col-lg-10">
			<textarea name="descripcion_corta_articulo" id="descripcion_corta_articulo" style="width:100%; height:100px;" required></textarea> *
		</div>
	</div>                           
	<div class="row">
		<div class="col-sm-2 col-md-2 col-lg-2">
		...
		<div class="col-sm-10 col-md-10 col-lg-10">
			<textarea name="descripcion_completa_articulo" id="descripcion_completa_articulo" style="width:100%; height:200px;" required></textarea> *
		</div>
	</div>
	<div class="row">
		<div class="col-sm-2 col-md-2 col-lg-2">
		...
		<div class="col-sm-10 col-md-10 col-lg-10">
			<button type="submit" id="form_articulos_submit" name="form_articulos_submit" class="theme_button" onclick="nicEditors.findEditor('descripcion_corta_articulo').saveContent();nicEditors.findEditor('descripcion_completa_articulo').saveContent();">Registrar artículo</button>
		</div>
	</div>
	<div class="row">
      <div class="col-sm-2 col-md-2 col-lg-2">
